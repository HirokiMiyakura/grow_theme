  ...
  <section>
    ...
    <div class="outer-container">
      <div class="business-left">
        <img src="<?php echo get_template_directory_uri(); ?>/img/rocoreha/roco_2.jpg" alt="rocoreha">
      </div>
    ...
    <div data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="800">
      ...
      <div class="outer-container">
        <div class="business-left">
          <img src="<?php echo get_template_directory_uri(); ?>/img/rocoreha/roco_4.jpg" alt="rocoreha">
        </div>
        <div class="business-right" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="600">
  ...
  <section>
    <div data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="800">
      ...
      <div class="btn-outer">
        ...
        <div class="btn-wrap">
          <a href="<?php echo home_url(); ?>/contact-rocoreha" class="btn btn--sub btn-c"><i class="fa fas fa-envelope fa-position-left"></i>WEB申込みはこちら<br>24時間365日受付中</a>
        </div>
      </div>
    </div>
  </section>
